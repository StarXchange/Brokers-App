...
const DownloadCertificates = ({
  ...
  const handleDownload = async () => {
    ...
    try {
      ...
      setDownloadMessage(
        `Downloaded ${filteredCertificates.length} certificates successfully!`,
      );
    } catch (error) {
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs sm:text-sm text-gray-600">
                      {filteredCertificates.length} certificates match selected
                      date range
                    </p>
                  </div>
                </div>
              ...
              <div className="mt-4 p-3 sm:p-4 bg-green-50 border border-green-200 rounded-lg">
                <div className="flex items-start sm:items-center">
                  ...
                  <span className="text-xs sm:text-sm font-medium text-green-800">
                    ...
                    {formatDate(date2)} | {filteredCertificates.length}{" "}
                    certificates found
                  </span>
                </div>
              </div>
              ...
              {isDownloading ? (
                ...
                <>
                  ...
                  <span className="hidden sm:inline">
                    DOWNLOAD CERTIFICATES ({filteredCertificates.length})
                  </span>
